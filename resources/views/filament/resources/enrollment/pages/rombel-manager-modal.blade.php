<div class="space-y-6" x-data="{ 
    ...
    <!-- External Styled CSS (mencegah tailwind purging & merapikan file) -->
    <link rel="stylesheet" href="{{ asset('css/rombel-manager.css') }}?v={{ filemtime(public_path('css/rombel-manager.css')) }}">
                            ...
                            @foreach($leftStudents as $siswa)
                                <tr draggable="true" 
                                    ...
                                    <td class="rombel-td rombel-td-name">
                                        <!-- Drag Indicator -->
                                        <svg style="width: 0.875rem; height: 0.875rem; flex-shrink: 0;" class="text-zinc-600 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
