    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div class="max-w-3xl">
            ...
            <h1 class="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight mb-6">
                Presensi 
                <span class="bg-gradient-to-r from-brand-primary-light via-brand-secondary-light to-brand-info-light bg-clip-text text-transparent">
                    Digital
                </span>
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-3">
                ...
                @if(!$isTodayHoliday)
                <div class="flex items-center gap-2.5 bg-brand-accent-950/50 border border-brand-accent-700/30 backdrop-blur-sm px-5 py-3 rounded-2xl w-full sm:w-auto">
                    <span class="w-2.5 h-2.5 rounded-full bg-brand-accent-light animate-pulse flex-shrink-0"></span>
                    <div>
                        <p class="text-[10px] text-brand-accent-700 uppercase tracking-widest font-semibold leading-none mb-0.5">Hadir Hari Ini</p>
                        <span class="text-lg font-bold text-brand-accent-light leading-none">{{ $realStats['hadir_telat'] }} <span class="text-sm font-medium text-brand-accent-dark">siswa</span></span>
                    </div>
                </div>
                @endif
            </div>
