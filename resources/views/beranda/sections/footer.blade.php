            ...
            <div class="md:col-span-3 lg:col-span-3">
                @if($setting->link_pengaduan)
                    <div class="bg-white/10 backdrop-blur-md rounded-3xl p-5 border border-white/20 shadow-lg">
                        ...
                        <a href="{{ $setting->link_pengaduan }}" target="_blank" rel="noopener" 
                           class="block w-full py-2.5 bg-amber-400 hover:bg-amber-300 text-slate-900 font-extrabold text-center text-xs rounded-xl shadow-md transition-all">
                            Tulis Pengaduan <i class="fas fa-external-link-alt ml-1 text-[10px]"></i>
                        </a>
                    </div>
                @else
                    <div class="bg-white/10 backdrop-blur-md rounded-3xl p-5 border border-white/20">
                        <h4 class="text-white font-bold mb-2 text-sm flex items-center gap-2">
                            <i class="fas fa-info-circle text-amber-300"></i> Layanan Informasi
                        </h4>
                        <p class="text-xs text-white/80 leading-relaxed">
                            Portal informasi resmi sekolah terintegrasi dengan sistem presensi dan layanan digital.
                        </p>
                    </div>
                @endif
            </div>
