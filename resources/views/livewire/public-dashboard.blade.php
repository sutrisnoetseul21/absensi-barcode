            ...
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden lg:flex items-center space-x-1 xl:space-x-2 shrink-0">
                    ...
                    <a href="{{ $pengaturanSekolah?->barcode_scan_mode === 'nis' ? route('kiosk.scan-nis') : route('kiosk.scan') }}"
                        class="ml-2 xl:ml-3 flex items-center gap-2 bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-primary-light hover:to-brand-secondary-light text-white px-4 xl:px-5 py-2.5 rounded-xl font-bold text-xs xl:text-sm whitespace-nowrap shrink-0 shadow-lg shadow-brand-primary/30 transition-all duration-300 transform hover:scale-105 hover:shadow-brand-primary/50">
