<div class="min-h-screen bg-slate-100 flex items-center justify-center relative overflow-hidden font-sans" 
    ...
    <div class="relative w-full max-w-5xl mx-4 my-8">
        ...
        <div class="mt-4 bg-white/70 border border-slate-200 rounded-xl p-3.5 flex justify-between items-center text-xs text-slate-500 backdrop-blur-sm shadow-xs">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span x-text="isActive ? 'Sistem Aktif & Siap Scan' : 'Menunggu Aktivasi'"></span>
            </div>
        </div>
    </div>
