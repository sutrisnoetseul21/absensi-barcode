        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3.5">
            @php
                $stats = [
                    ...
                    ['label' => 'Akademik', 'count' => $totalAkademik, 'route' => 'portal-web.akademik', 'color' => 'teal', 'icon' => 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222'],
                    ...
                    ['label' => 'Akses Cepat', 'count' => $totalAksesCepat, 'route' => 'portal-web.akses-cepat', 'color' => 'emerald', 'icon' => 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1'],
                ];
            @endphp
