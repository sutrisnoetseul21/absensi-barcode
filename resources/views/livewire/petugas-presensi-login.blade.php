    ...
    <div class="relative hidden lg:flex lg:w-1/2 bg-slate-900 overflow-hidden items-center justify-center p-12 z-10">
        ...
        <div class="relative z-10 w-full max-w-lg text-left">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-xl font-bold text-white tracking-wide">Modul Presensi</h2>
            ...
            <h1 class="text-4xl lg:text-5xl font-extrabold text-white mb-6 leading-tight">
                Selamat Datang di <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-blue-300 drop-shadow-sm">Portal Kiosk Presensi</span>
            </h1>
            <p class="text-lg text-slate-300 leading-relaxed mb-8 max-w-md">
                Amankan akses ke perangkat pemindai barcode untuk mencatat kehadiran harian siswa secara mandiri dan cepat.
            </p>
            <div class="flex items-center gap-4 text-sm text-slate-400 font-medium">
                <div class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Kiosk Online</div>
                <span>&bull;</span>
    ...
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-transparent lg:bg-white relative z-10">
        ...
        <div class="mx-auto w-full max-w-sm bg-white/10 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border border-white/20 lg:border-none rounded-3xl lg:rounded-none p-6 sm:p-8 lg:p-0 shadow-2xl lg:shadow-none">
            ...
            <div class="lg:hidden text-center mb-8">
                ...
                <h2 class="text-2xl font-extrabold text-white tracking-tight drop-shadow-md">Portal Presensi</h2>
                <p class="text-sm text-teal-100 mt-1 drop-shadow-sm">Log in Petugas Piket / Admin</p>
            </div>

            <div>
                <h2 class="mt-6 text-3xl font-extrabold text-slate-900 tracking-tight hidden lg:block">Masuk ke Portal Kiosk</h2>
