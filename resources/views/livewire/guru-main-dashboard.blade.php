        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                ...
                <p class="text-white/85 text-sm sm:text-base mt-1 max-w-2xl leading-relaxed">
                    Kelola absensi kelas binaan, tanggapi permohonan ijin siswa, pendampingan SI-WALI, dan akses berbagai layanan akademik dengan mudah dari satu tempat.
                </p>
            </div>
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <h3 class="text-base font-extrabold text-slate-900 group-hover:text-brand-primary transition-colors flex items-center gap-1.5">
                            SI-WALI
                            <span class="text-xs font-normal text-slate-500">(Guru Wali)</span>
                        </h3>
