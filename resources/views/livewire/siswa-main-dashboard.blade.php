<div class="p-4 lg:p-8 space-y-6 max-w-7xl mx-auto pb-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow group">
            ...
            <h3 class="text-slate-500 font-medium mb-1">Kehadiran (Bulan Ini)</h3>
            <div class="text-4xl font-extrabold {{ $attendancePercentage >= 90 ? 'text-emerald-500' : ($attendancePercentage >= 75 ? 'text-amber-500' : 'text-rose-500') }} tracking-tight">
                {{ $attendancePercentage }}<span class="text-2xl text-slate-400">%</span>
            </div>
            <p class="text-sm text-slate-400 mt-2">Berdasarkan kalkulasi hari efektif sekolah bulan ini.</p>
            
            <a href="{{ route('portal-siswa.akademik') }}" class="mt-6 w-full py-3 px-4 bg-slate-50 hover:bg-brand-primary hover:text-white text-brand-primary font-bold rounded-xl transition-colors flex justify-center items-center gap-2">
        ...
        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow group">
            ...
            <h3 class="text-slate-500 font-medium mb-1">Status Perpustakaan</h3>
            ...
            <p class="text-sm text-slate-400 mt-2">Sedang Anda pinjam dari perpustakaan saat ini.</p>
            
            <a href="{{ route('portal-siswa.perpustakaan') }}" class="mt-6 w-full py-3 px-4 bg-slate-50 hover:bg-brand-primary hover:text-white text-brand-primary font-bold rounded-xl transition-colors flex justify-center items-center gap-2">
                Buka Perpustakaan
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            </a>
        </div>
