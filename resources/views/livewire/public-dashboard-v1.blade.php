<div
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-3">
                    <div class="flex items-center gap-2.5 bg-white/5 border border-white/10 backdrop-blur-sm px-5 py-3 rounded-2xl">
                        ...
                        <div>
                            ...
                            <span x-text="formattedTime" class="font-mono text-lg font-bold text-white tabular-nums tracking-wider leading-none"></span>
                        </div>
                    </div>
                    <div class="flex items-center gap-2.5 bg-white/5 border border-white/10 backdrop-blur-sm px-5 py-3 rounded-2xl">
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <div>
                    ...
                    @if(!$isTodayHoliday)
                    <div class="flex items-center gap-2.5 bg-emerald-950/50 border border-emerald-700/30 backdrop-blur-sm px-5 py-3 rounded-2xl">
    ...
    <!-- SEKSI 7: Footer (Modern & Theme Matching) -->
