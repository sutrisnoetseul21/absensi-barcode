    ...
    <div class="relative hidden lg:flex lg:w-1/2 bg-slate-900 overflow-hidden items-center justify-center p-12 z-10">
        ...
        <div class="relative z-10 w-full max-w-lg text-left">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-xl font-bold text-white tracking-wide">Sistem Informasi</h2>
                    <p class="text-indigo-200 text-sm">Terpadu (ERP)</p>
                </div>
            </div>
            <h1 class="text-4xl lg:text-5xl font-extrabold text-white mb-6 leading-tight">
                Selamat Datang di <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-300 drop-shadow-sm">Portal Utama</span>
            </h1>
            <p class="text-lg text-slate-300 leading-relaxed mb-8 max-w-md">
                Satu gerbang masuk untuk seluruh Siswa, Guru, Staff, dan Admin. Sistem otomatis mengenali akses Anda.
            </p>
    ...
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-transparent lg:bg-white relative z-10">
        ...
        <div class="mx-auto w-full max-w-sm bg-white/10 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border border-white/20 lg:border-none rounded-3xl lg:rounded-none p-6 sm:p-8 lg:p-0 shadow-2xl lg:shadow-none">
            ...
            <div class="lg:hidden text-center mb-8">
                ...
                <h2 class="text-2xl font-extrabold text-white tracking-tight drop-shadow-md">Portal Utama</h2>
                <p class="text-sm text-indigo-100 mt-1 drop-shadow-sm">Sistem Informasi Terpadu</p>
            </div>

            <div>
                <h2 class="mt-6 text-3xl font-extrabold text-slate-900 tracking-tight hidden lg:block">Masuk ke Akun</h2>
                <p class="mt-2 text-sm text-slate-500 hidden lg:block">Silakan masukkan username/NISN/email dan password Anda.</p>
            </div>

            <div class="mt-8 lg:mt-10">
                <form wire:submit.prevent="login" class="space-y-5">
                    <div>
                        <label for="username" class="block text-sm font-semibold text-white lg:text-slate-700 mb-1.5 drop-shadow-sm lg:drop-shadow-none">Username / NISN / Email</label>
                ...
                <div class="mt-10 text-center text-xs text-slate-300 lg:text-slate-500 font-medium drop-shadow-sm lg:drop-shadow-none">
                    &copy; {{ date('Y') }} Hak Cipta Dilindungi.<br>Sistem Informasi Terpadu
                </div>
            </div>
        </div>
    </div>
