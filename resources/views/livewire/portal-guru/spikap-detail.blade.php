                        ...
                        @foreach($laporan->lampiran as $lampiran)
                            <div class="flex items-center justify-between p-3.5 bg-slate-50 border border-slate-200/70 rounded-xl gap-3">
                                <div class="flex items-center gap-3 min-w-0">
                                    <div class="w-10 h-10 rounded-lg {{ $lampiran->tipe_file === 'foto' ? 'bg-brand-primary/10 text-brand-primary' : 'bg-purple-100 text-purple-600' }} flex items-center justify-center shrink-0">
