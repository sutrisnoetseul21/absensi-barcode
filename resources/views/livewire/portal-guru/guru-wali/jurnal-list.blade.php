    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-primary/10 border border-brand-primary/20 text-brand-primary text-xs font-semibold mb-2">
                ...
                <span>SI-WALI • Jurnal Pendampingan Holistik Guru Wali</span>
            </div>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">SI-WALI: Jurnal Pendampingan Siswa</h1>
            <p class="text-xs text-brand-primary font-bold mt-1">
                "Satu Klik Ruang Aman, Dampingi Murid Wujudkan Masa Depan"
            </p>
            <p class="text-xs sm:text-sm text-slate-500 mt-0.5">
                Kelompok: <strong>{{ $kelompok->nama_kelompok }}</strong> &bull; Dokumentasi berkala pendampingan tumbuh kembang peserta didik.
            </p>
        </div>
