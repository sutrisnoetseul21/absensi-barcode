    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div x-show="showCetakModal" 
            ...
            <div class="bg-slate-50 px-6 py-4 border-t border-slate-200/80 flex items-center justify-end gap-3">
                ...
                <button type="button" wire:click="downloadCetakPdf" class="px-5 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl shadow-md shadow-emerald-600/30 transition-all flex items-center gap-2">
