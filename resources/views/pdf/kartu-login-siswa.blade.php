...
<head>
    ...
    <title>Pratinjau Kartu Siswa - {{ $student->name }}</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="print-panel">
            <h2 class="panel-title">Cetak Kartu Siswa</h2>
            ...
            <div class="student-summary">
                ...
                <div class="summary-row">
                    <span class="summary-label">{{ $identifierLabel }}</span>
                    <span class="summary-val">{{ $identifierValue }}</span>
                </div>
                <div class="summary-row">
