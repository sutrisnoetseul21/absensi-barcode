...
class SiswaUpdateNoHpExport implements FromQuery, WithHeadings, WithMapping, WithEvents, WithStyles, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Beri warna latar kuning pada header identitas (A1:E1)
