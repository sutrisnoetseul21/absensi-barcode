...
/**
 * Export data eksemplar buku dari SLiMS ke Excel.
 * Kolom: No | Kode Eksemplar | Judul Buku | Kode Inventaris | Status | Tgl Masuk | Harga
 */
class SlimsEksemplarExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithEvents, WithTitle
{
