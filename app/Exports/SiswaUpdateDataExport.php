...
class SiswaUpdateDataExport implements FromQuery, WithHeadings, WithMapping, WithEvents, WithStyles, ShouldAutoSize
{
    public function query()
    {
        return Siswa::query()->where('status', 'aktif')->orderBy('name', 'asc');
    }
