...
class PetugasPresensiLogin extends Component
{
    public $username = '';
    public $password = '';
    ...
    public function login()
    {
        ...
        $key = 'login-petugas-presensi:' . request()->ip() . ':' . $this->username;
        ...
        if (Auth::guard('web')->attempt(['email' => $email, 'password' => $this->password], $this->remember) ||
            ...
            return redirect()->intended('/portal-presensi/scan');
        }
    ...
    public function render()
    {
        ...
        return view('livewire.petugas-presensi-login', [
            'pengaturanSekolah' => $settings
        ])->title('Login Portal Presensi');
    }
}
