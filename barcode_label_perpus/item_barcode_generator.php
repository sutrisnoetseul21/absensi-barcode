...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  if ($file_write) {
    ...
    echo '<script type="text/javascript">top.$.colorbox({href: "'.SWB.FLS.'/'.$print_file_name.'?v='.time().'", iframe: true, width: 800, height: 500, title: "'.__('Item Barcodes Printing').'"})</script>';
